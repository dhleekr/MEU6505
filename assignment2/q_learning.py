...
class Agent:
    ...
    def play(self, episodes=300, verbose=False, logging=False):
        tic = time()
        done_epi = 0
        ...
        for episode in range(episodes):
            ...
            while True:
                ...
                if state == (0, 3):
                    ...
                    self.reward_list.append(self.sumofreward)
                    break
            ...
            if (done_epi == 0):
                ...
                diff = np.linalg.norm(q_values_vec[:] - last_q_values_vec[:], 1)
...
#         print(len(history_1epi))
    ...
    plt.figure(1)
    plt.plot(game_len, label = 'Q-learning')
    ...
    # plt.title('Q-learning reward sum')
    # plt.legend()
    # plt.xlabel('episode')
    # plt.ylabel('reward')
    # plt.grid(True)
    ...
    # plt.title('Q-learning converge time')
    # plt.xlabel('episode')
    # plt.ylabel('time')
    # plt.legend()
    # plt.grid(True)
    ...
    # plt.title('Q-learning converge iteration')
    # plt.xlabel('episode')
